...
void EXTI2_IRQHandler(void)
{
  /* USER CODE BEGIN EXTI2_IRQn 0 */
	//KEY_6
	ks.key_dpress_flag=0;

  /* USER CODE END EXTI2_IRQn 0 */
  HAL_GPIO_EXTI_IRQHandler(KEY_6_EXTI2_Pin);
...
void EXTI3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(KEY_5_EXTI3_Pin);
...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(KEY_4_EXTI4_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(KEY_3_EXTI5_Pin);
  HAL_GPIO_EXTI_IRQHandler(KEY_2_EXTI6_Pin);
  HAL_GPIO_EXTI_IRQHandler(KEY_1_EXTI7_Pin);
